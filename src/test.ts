...
import { ColorKey, contrast, fontColors } from './model';
...
console.log('\nall colors:');
const isColor = (name: string): name is keyof ColorKey => fontColors.hasOwnProperty(name);
const colorList: Array<keyof ColorKey> = Object.keys(fontColors).filter(isColor);
console.log(
